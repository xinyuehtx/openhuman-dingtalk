...
const fr4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    "Les autorisations de l'agent OpenHuman 钉钉 sont contrôlées ci-dessous par des bascules lecture, écriture et admin.",
  ...
  'daemon.serviceBlockingGate.title': 'Le core OpenHuman 钉钉 est indisponible',
