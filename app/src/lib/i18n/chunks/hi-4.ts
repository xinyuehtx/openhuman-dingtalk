...
const hi4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'OpenHuman 钉钉 की अपनी एजेंट अनुमतियाँ नीचे पढ़ें, लिखें और एडमिन टॉगल के रूप में नियंत्रित होती हैं।',
  ...
  'daemon.serviceBlockingGate.title': 'OpenHuman 钉钉 कोर उपलब्ध नहीं है',
  ...
  'overlay.ariaOrb': 'OpenHuman 钉钉 ओवरले',
