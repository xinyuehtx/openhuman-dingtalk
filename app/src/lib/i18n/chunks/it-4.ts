...
const it4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    "Le autorizzazioni proprie dell'agente OpenHuman 钉钉 sono controllate sotto come toggle di lettura, scrittura e admin.",
  ...
  'daemon.serviceBlockingGate.title': 'Il core di OpenHuman 钉钉 non è disponibile',
  ...
  'overlay.ariaOrb': 'Overlay OpenHuman 钉钉',
