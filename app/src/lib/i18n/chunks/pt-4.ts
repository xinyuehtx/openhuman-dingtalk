...
const pt4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'As permissões do agente do OpenHuman 钉钉 são controladas abaixo como botões de leitura, escrita e admin.',
  ...
  'daemon.serviceBlockingGate.title': 'O core do OpenHuman 钉钉 está indisponível',
  ...
  'overlay.ariaOrb': 'Orb do OpenHuman 钉钉',
