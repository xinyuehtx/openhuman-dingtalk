...
const ru4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'Собственные права агента OpenHuman 钉钉 настраиваются ниже переключателями чтения, записи и администратора.',
  ...
  'daemon.serviceBlockingGate.title': 'Ядро OpenHuman 钉钉 недоступно',
  ...
  'overlay.ariaOrb': 'Оверлей OpenHuman 钉钉',
