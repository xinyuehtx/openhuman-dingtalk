...
const ar4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'أذونات وكيل OpenHuman 钉钉 الخاصة يتم التحكم بها أدناه عبر مفاتيح القراءة والكتابة والإدارة.',
  ...
  'daemon.serviceBlockingGate.title': 'نواة OpenHuman 钉钉 غير متاحة',
  ...
  'overlay.ariaOrb': 'تراكب OpenHuman 钉钉',
