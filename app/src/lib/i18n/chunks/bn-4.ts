...
const bn4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'OpenHuman 钉钉-এর নিজস্ব এজেন্ট অনুমতি নিচে read, write, এবং admin টগল হিসেবে নিয়ন্ত্রিত।',
  ...
  'daemon.serviceBlockingGate.title': 'OpenHuman 钉钉 কোর পাওয়া যাচ্ছে না',
  ...
  'overlay.ariaOrb': 'OpenHuman 钉钉 ওভারলে',
