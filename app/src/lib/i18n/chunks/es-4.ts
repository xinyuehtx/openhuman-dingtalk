...
const es4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'los propios permisos del agente de OpenHuman 钉钉 se controlan abajo con conmutadores de lectura, escritura y administración.',
  ...
  'daemon.serviceBlockingGate.title': 'El core de OpenHuman 钉钉 no está disponible',
  ...
  'overlay.ariaOrb': 'Overlay de OpenHuman 钉钉',
