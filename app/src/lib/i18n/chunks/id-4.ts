...
const id4: TranslationMap = {
  ...
  'composio.connect.permissionsNoteSuffix':
    'Izin agen milik OpenHuman 钉钉 dikendalikan di bawah sebagai sakelar read, write, dan admin.',
  ...
  'daemon.serviceBlockingGate.title': 'Core OpenHuman 钉钉 tidak tersedia',
